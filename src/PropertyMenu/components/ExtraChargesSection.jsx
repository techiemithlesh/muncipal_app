...
const ExtraChargesSection = ({
  mobileTower, setMobileTower, towerArea, setTowerArea, installationDate, setInstallationDate, showInstallationDatePicker, setShowInstallationDatePicker,
  hoarding, setHoarding, hoardingArea, setHoardingArea, hoardingInstallationDate, setHoardingInstallationDate, showHoardingInstallationDatePicker, setShowHoardingInstallationDatePicker,
  petrolPump, setPetrolPump, pumpArea, setPumpArea, pumpInstallationDate, setPumpInstallationDate, showPumpInstallationDatePicker, setShowPumpInstallationDatePicker,
  rainHarvesting, setRainHarvesting, completionDate, setCompletionDate, showDatePicker, setShowDatePicker,
  yesNoOptions,
  isRessessment = false,
  isMutation = false
}) => {
  ...
  <View style={{ marginBottom: 20 }}>
    <Text style={{ fontSize: 14, color: '#555', marginBottom: 5 }}>Mobile Tower</Text>
    <Dropdown
    ...
    {mobileTower === 'yes' && (
      <View style={{ marginBottom: 12 }}>
        <Text style={{ fontSize: 14, color: '#555', marginBottom: 5 }}>
          Total Area Covered by Mobile Tower & Supporting Equipments (in Sq. Ft.)
        </Text>
        <TextInput
    ...
    <Text style={{ fontSize: 14, color: '#555', marginBottom: 5 }}>Does Property Have Hoarding Board(s) ? *</Text>
    <Dropdown
      style={{ height: 45, borderColor: '#ccc', borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, backgroundColor: '#fff', marginBottom: 12, justifyContent: 'center' }}
      data={yesNoOptions}
      labelField="label"
    ...
    {hoarding === 'yes' && (
      <View style={{ marginBottom: 12 }}>
        ...
        <TouchableOpacity
          style={{ borderWidth: 1, borderColor: '#ccc', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, backgroundColor: '#fff', marginBottom: 12, justifyContent: 'center' }}
          onPress={() => !isDisabled && setShowHoardingInstallationDatePicker(true)}
        >
        ...
        {showHoardingInstallationDatePicker && !isDisabled && (
          <DateTimePicker
            value={hoardingInstallationDate ? new Date(hoardingInstallationDate) : new Date()}
            mode="date"
            display="default"
            onChange={(event, selectedDate) => {
    ...
    <Text style={{ fontSize: 14, color: '#555', marginBottom: 5 }}>Is property a Petrol Pump ? *</Text>
    <Dropdown
      style={{ height: 45, borderColor: '#ccc', borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, backgroundColor: '#fff', marginBottom: 12, justifyContent: 'center' }}
      data={yesNoOptions}
      labelField="label"
    ...
    {petrolPump === 'yes' && (
      <View style={{ marginBottom: 12 }}>
        ...
        <TouchableOpacity
          style={{ borderWidth: 1, borderColor: '#ccc', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, backgroundColor: '#fff', marginBottom: 12, justifyContent: 'center' }}
          onPress={() => !isDisabled && setShowPumpInstallationDatePicker(true)}
        >
        ...
        {showPumpInstallationDatePicker && !isDisabled && (
          <DateTimePicker
            value={pumpInstallationDate ? new Date(pumpInstallationDate) : new Date()}
            mode="date"
            display="default"
            onChange={(event, selectedDate) => {
    ...
    <Text style={{ fontSize: 14, color: '#555', marginBottom: 5 }}>Rainwater harvesting provision ? *</Text>
    <Dropdown
      style={{ height: 45, borderColor: '#ccc', borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, backgroundColor: '#fff', marginBottom: 12, justifyContent: 'center' }}
      data={yesNoOptions}
      labelField="label"
